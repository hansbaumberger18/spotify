...
def get_mean_vector(song_list):
    ...
    for song in song_list:
        ...
        if song_data is None:
            print('Does not exist in Spotify')
            continue
...
inputs = (user_input_song,user_input_artist)
#input_song = input('Enter song name:')
#input_artist = input('Enter artist name:')
list_of_songs = []
list_of_songs.append(inputs)
#recomentations = recommend_songs(song_list = list_of_songs)


st.dataframe(data=recommend_songs(song_list = list_of_songs), width=None, height=None)
